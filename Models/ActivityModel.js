...
let activityModel = {
    getActivities: function(callback) {
        return db.query('SELECT idActivity, Event_idEvent, startTime , endTime ,  `name` ,  `description` FROM Activity', callback);
    },
    getActivity: function(id, callback) {
        return db.query('SELECT idActivity, Event_idEvent, startTime, endTimE, name, description FROM `Activity` WHERE idActivity = ' + id, callback);
    },
